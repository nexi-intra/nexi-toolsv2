...
DROP TABLE IF EXISTS public.tool_m2m_country;DROP TABLE IF EXISTS public.tool_m2m_purpose;DROP TABLE IF EXISTS public.tool_m2m_userrole;DROP TABLE IF EXISTS public.tool_m2m_accesspoint;
