...
{{ template "tenant_update_proc.sql".}} {{ template "tenant_patch_proc.sql".}} 
{{ template "tenant_delete_proc.sql".}} 
{{ template "tenant_undo_delete_proc.sql".}} 
{{ template "board_create_proc.sql".}} 
{{ template "board_update_proc.sql".}} {{ template "board_patch_proc.sql".}} 
{{ template "board_delete_proc.sql".}} 
{{ template "board_undo_delete_proc.sql".}} 
{{ template "setting_create_proc.sql".}} 
{{ template "setting_update_proc.sql".}} {{ template "setting_patch_proc.sql".}} 
{{ template "setting_delete_proc.sql".}} 
{{ template "setting_undo_delete_proc.sql".}} 
{{ template "bucket_create_proc.sql".}} 
{{ template "bucket_update_proc.sql".}} {{ template "bucket_patch_proc.sql".}} 
{{ template "bucket_delete_proc.sql".}} 
{{ template "bucket_undo_delete_proc.sql".}} 
