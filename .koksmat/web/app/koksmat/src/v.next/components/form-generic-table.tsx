...
type GenericTableFormProps2<T extends z.ZodObject<any, any, any>> = {
  databaseName: string;
  tableName: string;
  schema: T;
  showModeSelector?: boolean
...
export function GenericTableEditor2<T extends z.ZodObject<any, any>>({
  schema,
  tableName,
  databaseName,
  showModeSelector = false,
