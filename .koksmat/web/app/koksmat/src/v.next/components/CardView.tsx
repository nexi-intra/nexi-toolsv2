...
export function CardView<T extends { id: number, name: string, searchIndex: string }>({ renderItem, schema, items, onItemClick }: { renderItem?: RenderItemFunction<T>, schema: ZodObject<Record<string, z.ZodTypeAny>>, items: T[]; onItemClick: (item: T) => void; }) {
  return (
