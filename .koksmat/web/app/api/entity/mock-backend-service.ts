...
const db: Record<string, any[]> = {
  tool: [
    // Microsoft 365 Tools
    {
      ...
      groupId: "group1",
      purposes: [
        { key: "purpose1", value: "Collaboration", order: "1" },
        { key: "purpose2", value: "Communication", order: "2" },
      ],
      tags: [
        { key: "tag1", value: "Productivity", order: "1" },
        { key: "tag2", value: "Teamwork", order: "2" },
      ],
      version: "1.5.00.8070",
      status: "active",
      ...
      supportContact: [
        { key: "email", value: "support@microsoft.com", order: "1" },
      ],
      license: [{ key: "commercial", value: "Commercial", order: "1" }],
      ...
      countries: [{ key: "country1", value: "USA", order: "1" }],
      repositoryUrl: "https://github.com/microsoft/teams",
      collaborationType: [{ key: "type1", value: "Proprietary", order: "1" }],
      documents: [
        { name: "User Guide", url: "https://example.com/teams-user-guide.pdf" },
      ],
      teamSize: 500,
      primaryFocus: [{ key: "focus1", value: "Communication", order: "1" }],
    },
    {
      name: "Microsoft Word",
      ...
      groupId: "group1",
      purposes: [{ key: "purpose3", value: "Document Creation", order: "1" }],
      tags: [{ key: "tag1", value: "Productivity", order: "1" }],
      ...
      teamSize: 800,
      primaryFocus: [{ key: "focus1", value: "Productivity", order: "1" }],
    },
    // Google Workspace Tools
    {
      ...
      groupId: "group2",
      purposes: [{ key: "purpose3", value: "Document Creation", order: "1" }],
      tags: [{ key: "tag2", value: "Collaboration", order: "1" }],
      version: "N/A",
      status: "active",
      icon: "https://example.com/google-docs-icon.png",
      documentationUrl: "https://support.google.com/docs",
      supportContact: [
        { key: "email", value: "support@google.com", order: "1" },
      ],
      license: [{ key: "freemium", value: "Freemium", order: "1" }],
      compatiblePlatforms: ["Web", "iOS", "Android"],
      systemRequirements: "Modern web browser",
      countries: [{ key: "country1", value: "USA", order: "1" }],
      repositoryUrl: null,
      collaborationType: [{ key: "type1", value: "Cloud-Based", order: "1" }],
      documents: [
    ...
    },
    {
      ...
      groupId: "group2",
      purposes: [
        { key: "purpose3", value: "Data Analysis", order: "1" },
        { key: "purpose4", value: "Spreadsheet Management", order: "2" },
      ],
      tags: [{ key: "tag2", value: "Collaboration", order: "1" }],
      version: "N/A",
      status: "active",
    ...
    // Adobe Creative Cloud Tools
    {
      ...
      groupId: "group3",
      purposes: [{ key: "purpose5", value: "Graphic Design", order: "1" }],
      tags: [{ key: "tag3", value: "Design", order: "1" }],
      version: "2021 (22.4.2)",
      status: "active",
      icon: "https://example.com/photoshop-icon.png",
      documentationUrl: "https://helpx.adobe.com/photoshop",
      supportContact: [
        { key: "email", value: "support@adobe.com", order: "1" },
      ],
      license: [{ key: "commercial", value: "Commercial", order: "1" }],
      ...
      teamSize: 1000,
      primaryFocus: [{ key: "focus1", value: "Design", order: "1" }],
    },
    {
    ...
    // Slack Tools
    {
      ...
      url: "https://slack.com",
      groupId: "group4",
      purposes: [{ key: "purpose1", value: "Communication", order: "1" }],
      tags: [{ key: "tag4", value: "Messaging", order: "1" }],
      version: "4.19.2",
      status: "active",
      icon: "https://example.com/slack-icon.png",
      documentationUrl: "https://slack.com/help",
      supportContact: [
        { key: "email", value: "feedback@slack.com", order: "1" },
      ],
      license: [{ key: "freemium", value: "Freemium", order: "1" }],
      compatiblePlatforms: [
        "Windows",
    ...
    // Atlassian Suite Tools
    {
      ...
      groupId: "group5",
      purposes: [{ key: "purpose2", value: "Project Management", order: "1" }],
      tags: [{ key: "tag5", value: "Tracking", order: "1" }],
      version: "8.17.1",
      status: "active",
      icon: "https://example.com/jira-icon.png",
      documentationUrl: "https://confluence.atlassian.com/jira",
      supportContact: [
        { key: "email", value: "support@atlassian.com", order: "1" },
      ],
      license: [{ key: "commercial", value: "Commercial", order: "1" }],
      compatiblePlatforms: ["Web"],
      systemRequirements: "Modern web browser",
      countries: [{ key: "country1", value: "Australia", order: "1" }],
      repositoryUrl: null,
      collaborationType: [{ key: "type1", value: "Cloud-Based", order: "1" }],
      documents: [
        {
      ...
      teamSize: 1500,
      primaryFocus: [
        { key: "focus1", value: "Project Management", order: "1" },
      ],
    },
    {
      name: "Confluence",
      ...
      purposes: [
        { key: "purpose1", value: "Collaboration", order: "1" },
        { key: "purpose3", value: "Documentation", order: "2" },
      ],
      tags: [{ key: "tag5", value: "Knowledge Base", order: "1" }],
      version: "7.12.2",
      status: "active",
      ...
      teamSize: 1200,
      primaryFocus: [{ key: "focus1", value: "Collaboration", order: "1" }],
    },
    // Additional Tools
    {
      name: "Salesforce CRM",
      ...
      groupId: "group6",
      purposes: [{ key: "purpose3", value: "Sales Management", order: "1" }],
      tags: [{ key: "tag6", value: "CRM", order: "1" }],
      version: "Summer '21",
      status: "active",
      icon: "https://example.com/salesforce-icon.png",
      documentationUrl: "https://help.salesforce.com",
      supportContact: [
        { key: "email", value: "support@salesforce.com", order: "1" },
      ],
      license: [{ key: "commercial", value: "Commercial", order: "1" }],
      compatiblePlatforms: ["Web", "iOS", "Android"],
      systemRequirements: "Modern web browser",
      ...
      teamSize: 3000,
      primaryFocus: [{ key: "focus1", value: "Sales", order: "1" }],
    },
