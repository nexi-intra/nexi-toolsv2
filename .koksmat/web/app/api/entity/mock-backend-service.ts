...
const db: Record<string, any[]> = {
  tool: [
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      supportContact: "support@google.com",
      license: "Freemium",
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      supportContact: "feedback@slack.com",
      license: "Freemium",
      compatiblePlatforms: [
        "Windows",
        "macOS",
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      supportContact: "support@atlassian.com",
      license: "Commercial",
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      supportContact: "support@salesforce.com",
      license: "Commercial",
      compatiblePlatforms: ["Web", "iOS", "Android"],
      systemRequirements: "Modern web browser",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      ...
      version: "5.6.7",
      status: "active",
      icon: "https://example.com/zoom-icon.png",
      documentationUrl: "https://support.zoom.us",
      supportContact: "support@zoom.us",
      license: "Freemium",
      compatiblePlatforms: [
        "Windows",
        "macOS",
      ...
      systemRequirements: "Windows 7 or later, macOS 10.9 or later",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      name: "Dropbox",
      description: "File storage and sharing service",
      ...
      documentationUrl: "https://help.dropbox.com",
      supportContact: "support@dropbox.com",
      license: "Freemium",
      compatiblePlatforms: [
        "Windows",
        "macOS",
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      description: "Web-based interface for accessing AWS services",
      url: "https://aws.amazon.com/console/",
      groupId: "group9",
      purposeIds: ["purpose10"],
      tagIds: ["tag9"],
      version: "N/A",
      status: "active",
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      groupId: "group13",
      purposeIds: ["purpose3", "purpose2"],
      tagIds: ["tag13"],
      version: "2.0.16",
      status: "active",
      icon: "https://example.com/notion-icon.png",
      documentationUrl: "https://www.notion.so/help",
      supportContact: "team@makenotion.com",
      license: "Freemium",
      compatiblePlatforms: ["Windows", "macOS", "iOS", "Android", "Web"],
      systemRequirements: "Windows 7 or later, macOS 10.11 or later",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      name: "Asana",
      ...
      supportContact: "support@asana.com",
      license: "Freemium",
      compatiblePlatforms: ["Web", "iOS", "Android"],
      systemRequirements: "Modern web browser",
    }),
    ...
    createEntity(schemaMapObjects.tool, "system", {
      ...
      version: "19c",
      status: "active",
      icon: "https://example.com/oracle-icon.png",
      documentationUrl: "https://docs.oracle.com/en/database",
      supportContact: "support@oracle.com",
      license: "Commercial",
      compatiblePlatforms: ["Windows", "Linux", "Unix"],
      systemRequirements: "Contact Oracle for details",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      name: "IBM Cloud",
      ...
      groupId: "group17",
      purposeIds: ["purpose20"],
      tagIds: ["tag17"],
      version: "N/A",
      status: "active",
      icon: "https://example.com/ibm-cloud-icon.png",
      documentationUrl: "https://cloud.ibm.com/docs",
      supportContact: "support@ibm.com",
      license: "Commercial",
      compatiblePlatforms: ["Web"],
      systemRequirements: "Modern web browser",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      ...
      version: "12.5.1",
      status: "active",
      icon: "https://example.com/xcode-icon.png",
      documentationUrl: "https://developer.apple.com/documentation/xcode",
      supportContact: "developer_support@apple.com",
      license: "Free",
      compatiblePlatforms: ["macOS"],
      systemRequirements: "macOS 11 or later",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      name: "Cisco Webex",
      ...
      version: "41.6.4",
      status: "active",
      icon: "https://example.com/webex-icon.png",
      documentationUrl: "https://help.webex.com",
      supportContact: "support@webex.com",
      license: "Freemium",
      compatiblePlatforms: ["Windows", "macOS", "iOS", "Android", "Web"],
      systemRequirements: "Windows 7 or later, macOS 10.13 or later",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      ...
      version: "N/A",
      status: "active",
      icon: "https://example.com/hubspot-icon.png",
      documentationUrl: "https://knowledge.hubspot.com",
      supportContact: "support@hubspot.com",
      license: "Freemium",
      compatiblePlatforms: ["Web"],
      systemRequirements: "Modern web browser",
    }),
    createEntity(schemaMapObjects.tool, "system", {
      ...
      groupId: "group21",
      purposeIds: ["purpose15"],
      tagIds: ["tag21"],
      version: "N/A",
      status: "active",
      icon: "https://example.com/zendesk-icon.png",
      documentationUrl: "https://support.zendesk.com",
      supportContact: "support@zendesk.com",
      license: "Commercial",
      compatiblePlatforms: ["Web", "iOS", "Android"],
      systemRequirements: "Modern web browser",
    }),
